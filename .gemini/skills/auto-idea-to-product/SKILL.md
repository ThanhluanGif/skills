...
description: UNIVERSAL PROACTIVE AI CARD SKILL: Tự động chuyển đổi Prompt Terminal/Gemini thành Thẻ Task, AI tự đọc Thẻ & chạy tự động cho người dùng lười đọc, AI chủ động đề xuất Thẻ phát triển tiếp theo khi hết idea, NÉN THẺ PHÂN CẤP (10 Thẻ Lẻ -> 1 File Milestone -> 1 Báo Cáo Tổng To), và TỰ ĐỘNG VẼ ĐỒ THỊ CẤU TRÚC DỰ ÁN TRÊN INDEX.HTML.
---

# AUTO IDEA TO PRODUCT (PROACTIVE CARD & GRAPH VISUALIZER ENGINE)

> **Mục tiêu**: Hệ thống Skill tự động hóa 100%. Áp dụng Quy chế Nén Thẻ Phân Cấp (10-in-1 Compaction) và Tự động vẽ Đồ thị Kiến trúc Cấu trúc Dự án trên file `index.html`.

## 🎨 TỰ ĐỘNG VẼ ĐỒ THỊ CẤU TRÚC DỰ ÁN (`index.html`)

Hệ thống luôn tự động tạo và cập nhật file **`index.html`** ở thư mục gốc để trực quan hóa:
